...
DEBUG = config('ADMIN_DEBUG', default=False, cast=bool)

ALLOWED_HOSTS = ['localhost', '0.0.0.0', 'admin_api']
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.IsAuthenticated',  # Admin API requires authentication
    ],
...
# Redis Settings
REDIS_HOST = config('ADMIN_REDIS_HOST')
REDIS_PORT = config('ADMIN_REDIS_PORT')
